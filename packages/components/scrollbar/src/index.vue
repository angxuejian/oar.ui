...
import { type UseCommonProps, useCommonComputed, useNamespace } from '../../../hooks'
...
onMounted(() => {
  // calcThumbSize()
  useResizeObserver(wrapRef, useThrottleFn(() => {
    calcThumbSize()
  }, 500))

  useResizeObserver(wrapViewRef, useThrottleFn(() => {
    calcThumbSize()
  }, 500))
})
